...
public class ManuscriptController {
    ...
    public LinkedList<Manuscript> find(@RequestParam(value = "page", defaultValue = "1") int page, @RequestParam(value = "per_page", defaultValue = "10") int perPage) {
        long uid = 1; // 임시값
    ...
    public Manuscript findOne(@PathVariable("manuscriptId") long manuscriptId) {
